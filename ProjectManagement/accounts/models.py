...
def profile_image_path_location(instance, filename):
    ...
    # returnn the upload path
    return "media/profile/%s/%s/%s" % (instance.user.username, today_date, filename)
...
def create_user_profile(sender, instance, **kwargs):
    # is a user already exist, and has no prifile created
